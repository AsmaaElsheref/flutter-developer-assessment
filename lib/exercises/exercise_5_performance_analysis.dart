...
// =============================================================================
// YOUR ANALYSIS (Concise Version)
// =============================================================================

// ISSUE #1:
// IMPACT: Full screen rebuild every 30s.
// WHY: StreamBuilder at root.
// FIX: Remove it or move logic to BLoC/timer.

// ISSUE #2-4:
// IMPACT: All banner widgets rebuild on any user state change.
// WHY: Multiple BlocBuilders on same BLoC without buildWhen.
// FIX: Use buildWhen or BlocSelector per banner slice.

// ISSUE #5:
// IMPACT: Online badge rebuilds unnecessarily.
// WHY: Listening to full state for a boolean.
// FIX: buildWhen or BlocSelector<bool>.

// ISSUE #6:
// IMPACT: Layout body rebuilds on any LayoutState change.
// WHY: No buildWhen.
// FIX: buildWhen on currentIndex.

// ISSUE #7:
// IMPACT: Nested BlocBuilders cause redundant rebuilds.
// WHY: Two blocs listened together without filtering.
// FIX: Add buildWhen or flatten using BlocSelector.

// ISSUE #8:
// IMPACT: Wallet UI not reactive and recreated every build.
// WHY: ValueNotifier created inside build.
// FIX: Move outside build or use proper state.

// ISSUE #9:
// IMPACT: All tabs rebuild on any HomeState change.
// WHY: One BlocBuilder wraps entire TabView.
// FIX: Split into per-tab widgets using BlocSelector.

// ISSUE #10:
// IMPACT: Tab bar rebuilds with tab content.
// WHY: Shared BlocBuilder.
// FIX: Separate widgets.

// ISSUE #11:
// IMPACT: IndexedStack children rebuild unnecessarily.
// WHY: Same parent builder.
// FIX: Isolate each tab state.

// ISSUE #12:
// IMPACT: High CPU/memory usage.
// WHY: Using SVGA animations for nav icons.
// FIX: Replace with lightweight icons/animations.

// ISSUE #13:
// IMPACT: Increased memory usage.
// WHY: Static routes map holds closures forever.
//      Static routes eagerly store all route builders in memory, which can retain unnecessary closures and dependencies.
//      Using onGenerateRoute creates routes on demand, improving memory efficiency and scalability in large applications.

// FIX: Use onGenerateRoute.
// ISSUE #14:
// IMPACT: Potential bloc lifecycle issues.
// WHY: Overuse of BlocProvider.value.
// FIX: Use create for screen-scoped blocs. --> Use create when you need a new bloc instance with its own lifecycle.
// Use value only when passing an existing bloc down the widget tree.

// ISSUE #15:
// IMPACT: Useless state updates.
// WHY: ValueNotifier updated twice instantly.
// FIX: Emit meaningful single update.

// ISSUE #16:
// IMPACT: Minor performance overhead.
// WHY: Missing const widgets.
// FIX: Add const constructors.

// ISSUE #17:
// IMPACT: Over-fragmented banner rebuild logic.
// WHY: Separate builders for same data source.
// FIX: Combine or isolate via selector.

// ISSUE #18:
// IMPACT: Large rebuild surface.
// WHY: Monolithic HomeState.
// FIX: Split into feature-based states.
...
// =============================================================================
//
// Split HomeState into:
//
// - HomeTabState → currentTabIndex
// - PopularRoomsState → list + pagination
// - LiveRoomsState → list + pagination
// - FollowRoomsState → list + pagination
// - FriendsRoomsState → list + pagination
// - GlobalRoomsState → list + pagination
// - FilteredRoomsState → filters + results
//
// RESULT:
